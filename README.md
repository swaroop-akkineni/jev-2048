...
Use arrow keys, swipe the board, or tap the direction buttons. Equal tiles merge
once per move; merges add their value to your score. Each valid move adds a tile
(90% chance of 2, 10% chance of 4). You can keep playing after reaching 2048.
